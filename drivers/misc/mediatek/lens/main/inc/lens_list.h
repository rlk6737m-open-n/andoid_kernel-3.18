...
#ifdef CONFIG_MTK_LENS_DW9800BAF_SUPPORT
#define DW9800BAF_SetI2Cclient DW9800BAF_SetI2Cclient_Main
#define DW9800BAF_Ioctl DW9800BAF_Ioctl_Main
#define DW9800BAF_Release DW9800BAF_Release_Main
extern void DW9800BAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long DW9800BAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9800BAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
